...
class SemiDetachedHomeTypeActivity : AppCompatActivity() {
    ...
    public var houseType : HouseType = HouseType.SemiDetached
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        homeTypeToolbarBundle.putString("title", getString(R.string.home_menu_semi_detached))
        ...
        houseListBundle.putString("type", HouseType.SemiDetached.name)
